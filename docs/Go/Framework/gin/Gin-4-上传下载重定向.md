...
!!! note ""
    === "前端部分"
        ...
        ![](https://xcdn.loli.top/gh/TCP404/Picgo/blog/illustration-pic/Go/vx_images/6000782296428.png)
    ...
    === "测试"
        ...
        ![上传文件](https://xcdn.loli.top/gh/TCP404/Picgo/blog/illustration-pic/Go/vx_images/1762924054854.png)

        ![上传成功](https://xcdn.loli.top/gh/TCP404/Picgo/blog/illustration-pic/Go/vx_images/5500107717484.png)

        ![成功保存](https://xcdn.loli.top/gh/TCP404/Picgo/blog/illustration-pic/Go/vx_images/5880663088309.png)

    === "使用 Postman"

        使用 PostMan 时需要给 Header 添加一个属性 `Content-Type: multipart/form-data`

        ![](https://xcdn.loli.top/gh/TCP404/Picgo/blog/illustration-pic/Go/vx_images/3692804942610.png)

        然后在 Body 中的 form-data 中上传数据

        ![](https://xcdn.loli.top/gh/TCP404/Picgo/blog/illustration-pic/Go/vx_images/1504988688338.png)
...
![](https://xcdn.loli.top/gh/TCP404/Picgo/blog/illustration-pic/Go/vx_images/1820376192887.png)
...
![重定向和转发](https://xcdn.loli.top/gh/TCP404/Picgo/blog/illustration-pic/Go/vx_images/3628459928845.png)
...
=== "重定向"
    ...
    ![重定向到站内](https://xcdn.loli.top/gh/TCP404/Picgo/blog/illustration-pic/Go/vx_images/5296060724295.png)

    ![重定向到站外](https://xcdn.loli.top/gh/TCP404/Picgo/blog/illustration-pic/Go/vx_images/3265866644390.png)
...
=== "转发"
    ...
    ![转发到站内](https://xcdn.loli.top/gh/TCP404/Picgo/blog/illustration-pic/Go/vx_images/623353626862.png)
